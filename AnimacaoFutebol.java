...
// ---------------------Apresentação-------------------------------------------------------------------
	     ...
	     for (int s = 0; s <= 800; s += 80) {
		        ...
		        g.drawString("Universidade Federal Do Pará", 30 , s);
		        g.setFont(new Font("Arial", Font.BOLD, 30));//tamanho da fonte
		        g.drawString("Curso de Engenharia Da Computação", 30, s + 30);
		        g.drawString("Disciplina : Algoritmos e Programação de Computadores II", 30, s + 60);
		        g.drawString("Trabalho de Animação Java 2D", 30, s + 90);
		        g.drawString("Professor Manuel Ribeiro", 30, s + 120);
		        g.drawString("Alunos :  Thiago Souza", 30, s + 150);
		        g.drawString("                 Danilo Pena", 30, s + 180);


		            //Parada de Tempo para visualização da abertura
		            if (s != 160) {
		               // tempo de atraso
		                try {
		                    Thread.sleep(500);
